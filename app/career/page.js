        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-muted text-lg md:text-xl leading-relaxed max-w-2xl font-normal">
              We are a team of curious builders, AI engineers, and systems architects solving complex problems with elegance. Explore our 4 current openings below.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 pb-6 border-b border-cream-border gap-6">
            <div>
              <span className="text-accent text-xs md:text-sm font-semibold tracking-widest uppercase mb-2 block">
                OPEN OPPORTUNITIES (4 POSITIONS)
              </span>
            ...
            {/* Filter Pills */}
            <div className="flex items-center gap-2 bg-cream-soft p-1.5 rounded-full border border-cream-border">
              <button
